...
/** Generated Model for C_CF_TemplateLine
...
public class X_C_CF_TemplateLine extends PO implements I_C_CF_TemplateLine, I_Persistent 
{
    ...
    public X_C_CF_TemplateLine (Properties ctx, int C_CF_TemplateLine_ID, String trxName)
    {
      super (ctx, C_CF_TemplateLine_ID, trxName);
      /** if (C_CF_TemplateLine_ID == 0)
        {
			setC_CF_Template_ID (0);
			setC_CF_TemplateLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_C_CF_TemplateLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_CF_TemplateLine[")
	...
	/** Set Cash Forecasting Template Line.
		@param C_CF_TemplateLine_ID Cash Forecasting Template Line	  */
	public void setC_CF_TemplateLine_ID (int C_CF_TemplateLine_ID)
	{
		if (C_CF_TemplateLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_CF_TemplateLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_CF_TemplateLine_ID, Integer.valueOf(C_CF_TemplateLine_ID));
	}

	/** Get Cash Forecasting Template Line.
		@return Cash Forecasting Template Line	  */
	public int getC_CF_TemplateLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_CF_TemplateLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set C_CF_TemplateLine_UU.
		@param C_CF_TemplateLine_UU C_CF_TemplateLine_UU	  */
	public void setC_CF_TemplateLine_UU (String C_CF_TemplateLine_UU)
	{
		set_Value (COLUMNNAME_C_CF_TemplateLine_UU, C_CF_TemplateLine_UU);
	}

	/** Get C_CF_TemplateLine_UU.
		@return C_CF_TemplateLine_UU	  */
	public String getC_CF_TemplateLine_UU () 
	{
		return (String)get_Value(COLUMNNAME_C_CF_TemplateLine_UU);
	}
